...
/**
 *
 * Class SinNotificar | reportes/SinNotificar.class.php
 *
 * @package     Leishmania
 * @subpackage  Reportes
 ...
 * que tienen una determinaciones y que aún no fueron notificados
 * al sisa
 *
...
class SinNotificar{
    ...
    public function __construct(){
        ...
        $this->Documento->SetSubject("Pacientes con determinaciones sin notificar", true);
