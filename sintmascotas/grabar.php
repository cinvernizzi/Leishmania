...
$sintomas->setConjuntivitis($_POST["Conjuntivitis"]);
...
$sintomas->setAlopeciaGeneralizada($_POST["AlopeciaGeneralizada"]);
...
$sintomas->setSeborreaEscamosa($_POST["SeborreaEscamosa"]);
